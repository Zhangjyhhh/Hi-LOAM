...
class dataSampler():
    ...
    def sample(self, points_torch, 
        ...
        depths_tensor = depths_tensor /world_scale # unit: m
        ...
        weight_tensor[point_num * surface_sample_n:] = weight_tensor[point_num * surface_sample_n:] * -1.0
        
        # ray-wise depth
        distances = distances / world_scale # unit: m
